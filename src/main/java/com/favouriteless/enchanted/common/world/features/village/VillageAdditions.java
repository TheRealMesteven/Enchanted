package com.favouriteless.enchanted.common.world.features.village;
...
public class VillageAdditions {
    ...
    /**
     * Adds buildings to the targeted pool.
    ...
    public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
        ...
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ...
                "enchanted:enchanted.plains.apothecarys", 50);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/desert/houses"),
                "enchanted:enchanted.desert.apothecarys", 50);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                new ResourceLocation("minecraft:village/savanna/houses"),
                "enchanted:enchanted.savanna.apothecarys", 50);
